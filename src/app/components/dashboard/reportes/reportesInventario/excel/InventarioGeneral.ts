...
export class InventarioGeneral {
    ...
    public async dowloadExcel(dataExcel: any): Promise<void> {
        ...
        this._workbook.xlsx.writeBuffer().then((data) => {
          ...
          fs.saveAs(blob, 'Inventario General.xlsx');
        });
    }
    ...
    private async _createHeroTable(data: any): Promise<void> {
        ...
        tituloReporteCell.value = 'INVENTARIO GENERAL A CORTE DE  '+moment(new Date()).format("DD-MM-YYYY").toUpperCase();
        ...
        for (let index = 0; index < rowsToInsert.length; index++) {
          ...
          row.values = [
            itemData.codigo,
            itemData.bodega__nombre,
            itemData.marca,
            itemData.nombre, 
            itemData.Lote,
            itemData.Vence,
            itemData.Existencia,
            itemData.valor_compra,
            itemData.valorVenta,
            itemData.impuesto,
            itemData.ubicacion,
            itemData.filtro,
