...
export class EstadoDeCarteraCliente {
    ...
    private async _createHeroTable(data: any): Promise<void> {
        ...
        clienteCell.value = 'CLIENTE - RAZON SOCIAL';
        clienteCell.fill = {
          type: 'pattern',
          pattern: 'solid',
          fgColor: { argb: 'C5C6C6' },
        ...
        clienteCellValue.value = data.documento+' - '+data.cliente;
        ...
        sheet.views = [
          {
            state: 'frozen',
            ySplit: 15, // El índice de la fila menos 1
          },
        ];
