...
export class InventarioVencido {
    ...
    public async dowloadExcel(dataExcel: any): Promise<void> {
        ...
        this._workbook.xlsx.writeBuffer().then((data) => {
          ...
          fs.saveAs(blob, 'Inventario Vencido.xlsx');
        });
    }
    ...
    private async _createHeroTable(data: any): Promise<void> {
        ...
        const sheet = this._workbook.addWorksheet("Inventario");
        ...
        tituloReporteCell.value = 'INVENTARIO VENCIDO A CORTE DE  '+moment(new Date()).format("DD-MM-YYYY").toUpperCase();
