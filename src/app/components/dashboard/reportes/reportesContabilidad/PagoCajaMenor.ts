...
export class PagoCajaMenor {
    ...
    public ReportePagoCajaMenor(data:any){
        ...
        for(let x of clientes){
            ...
            doc.text(data.caja.numero_str,52.5, startYText,{align:"center"});
            ...
            doc.line(15,finalY+75,120,finalY+75);
            doc.text("FIRMA DEL RECIBIDO",25, finalY+84);
        ...
        for (let i = 1; i <= pageCount; i++) {
            ...
            doc.text('Pagina ' + String(i) + ' de ' + String(pageCount), 530, 129,{
                align:'left'
            }); 
    ...
    setEncabezado(doc:jsPDF,data){
                   ...
                   doc.setFontSize(14)
                   doc.setFont(undefined,'bold');
                   doc.text('RECIBO DE CAJA MENOR', 307, 105, { align: "center" })
       
                
                    // Movimiento #
                   doc.setFontSize(10)
                   doc.text('RECIBO N°.', 495, 55, { align: "center" })
                   doc.setFont(undefined, 'normal')
                   doc.text(data.numero_str, 495, 70, { align: "center" })
                   doc.setFontSize(7)
    ...
    setEncabezadoTabla(doc:jsPDF, startY:number, startYText:number){
        ...
        doc.setFontSize(8);
        doc.setFont(undefined,'bold');
        doc.text("CAJA N°",52.5, startYText,{align:"center"});
