...
@Component({
  selector: 'app-ModalRetencionProveedor',
  templateUrl: './ModalRetencionProveedor.component.html',
  styleUrls: ['./ModalRetencionProveedor.component.scss']
})
export class ModalRetencionProveedorComponent implements OnInit {
  ...
  guardar(){
    ...
    this.config.saveRetencionesProveedor(retencion).subscribe(resp => {
      this.resetform();
