...
@Component({
  selector: 'app-listadoNotaCredito',
  templateUrl: './listadoNotaCredito.component.html',
  styleUrls: ['./listadoNotaCredito.component.css']
})
export class ListadoNotaCreditoComponent implements OnInit {
  urlActual:string;
    ...
    this.table =  $('#Table'+idtable).DataTable({
      ...
      columnDefs:[
          ...
          },
          {
            ...
            orderable: true,
            render: function(data,type,row){
                let estado = new BooleanPipe();
                let conta = estado.transform(data);
          ...
          },
          {
            ...
            render: function(data,type,row){
                let estado = new BooleanPipe();
                let nulls = estado.transform(data);
