...
@Component({
  selector: 'app-prospectoVenta',
  templateUrl: './prospectoVenta.component.html',
  styleUrls: ['./prospectoVenta.component.css']
})
export class ProspectoVentaComponent implements OnInit {
