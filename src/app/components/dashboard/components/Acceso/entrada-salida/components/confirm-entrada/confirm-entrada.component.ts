...
@Component({
  selector: 'app-confirm-entrada',
  templateUrl: './confirm-entrada.component.html',
  styleUrls: ['./confirm-entrada.component.css']
})
export class ConfirmEntradaComponent implements OnInit {
